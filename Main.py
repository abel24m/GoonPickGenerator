...
for player in players:
    if dataMiner.doesPlayerExist(player.name):
        ...
        playerData = [player.name, player.prizepick, player.prjKills, player.spread, player.prjKillsWithOvertime, player.spreadWithOvertime, player.totalSpreadCombined]
